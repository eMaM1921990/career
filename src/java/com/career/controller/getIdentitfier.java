 ...
 * @author emam
 */
public class getIdentitfier extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String companyrow="<div class=\"control-group\">"
                    ...
                    + "<input type=\"text\"  id=\"COMPANY_NAME\" autocomplete=\"off\" >"
                    + "</div>"
                    + "</div>"
                    + "</div>";
        ...
        String positionrow="<div class=\"control-group\">"
                    ...
                    + "<input type=\"text\"  id=\"POSITION_NAME\" autocomplete=\"off\" >"
                    + "</div>"
                    + "</div>"
                    + "</div>";
        ...
        String phone_row="<div class=\"control-group\">"
                    ...
                    + "<input type=\"text\"  id=\"PHONE\" autocomplete=\"off\" onkeypress=\"return isNumber(event)\">"
                    + "</div>"
                    + "</div>"
                    + "</div>";
