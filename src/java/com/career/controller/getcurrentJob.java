 ...
 * @author emam
 */
public class getcurrentJob extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String row="<div class=\"control-group\">"
                ...
                + "<input type=\"text\" placeholder=\"Required Job\" id=\"job_name\" autocomplete=\"off\" value='"+j.getName()+"' style='pointer-events:none;border:none;background:#fff'>"
        ...
        String rowcombo="<div class=\"control-group\">"
                ...
                + "<select name=\"employment_type_id\" id=\"employment_type_id\" class='chosen-select' style='pointer-events:none;border:none;background:#fff'>";
        ...
        String rowcombo2="<div class=\"control-group\">"
                ...
                + "<div class=\"input-prepend\">"
                + "<div class=\"input-xlarge\">"
                + "<select name=\"employement_status_id\" id=\"employement_status_id\" class='chosen-select' style='pointer-events:none;border:none;background:#fff'>";
        ...
        String salaryrow="<div class=\"control-group\">"
                ...
                + "<div class=\"input-prepend\">"
                + "<div class=\"input-xlarge\">"
                + "<input type=\"text\" placeholder=\"Salary\" id=\"salary_amount\" autocomplete=\"off\" value='"+j.getSalary()+"' style='pointer-events:none;border:none;background:#fff'>"
                + "<select name=\"salary_id\" id=\"salary_id\" class='chosen-select' style='pointer-events:none;border:none;background:#fff'>";
        ...
        String rowcombo3="<div class=\"control-group\">"
                ...
                + "<div class=\"input-prepend\">"
                + "<div class=\"input-xlarge\">"
                + "<select name=\"career_level_id\" id=\"career_level_id\" class='chosen-select' style='pointer-events:none;border:none;background:#fff'>";
        ...
        String rowcombo4="<div class=\"control-group\">"
                ...
                + "<div class=\"input-prepend\">"
                + "<div class=\"input-xlarge\">"
                + "<select name=\"notice_period_id\" id=\"notice_period_id\" class='chosen-select' style='pointer-events:none;border:none;background:#fff'>";
         ...
         String lastsalaryrow="<div class=\"control-group\">"
                ...
                + "<div class=\"input-prepend\">"
                + "<div class=\"input-xlarge\">"
                + "<input type=\"text\" placeholder=\"Salary\" id=\"last_salary_amount\" autocomplete=\"off\" value='"+j.getLastSalary()+"' style='pointer-events:none;border:none;background:#fff'>"
                + "<select name=\"last_salary_id\" id=\"last_salary_id\" class='chosen-select' style='pointer-events:none;border:none;background:#fff'>";
        ...
        String actionrow="<div class=\"form-actions\">"
                + "<input class=\"btn btn-primary\" value=\"حفظ\" type=\"submit\" id=\"savejob\">"
