...
public class getEditMember extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        MemberShip m=dao.Find(request.getParameter("id"));
        ...
        String name_row="<div class=\"control-group\">"
                    ...
                    + "<input type=\"text\"  id=\"COMP_NAME\" autocomplete=\"off\" value='"+m.getCompname()+"'>"
                    + "</div>"
                    + "</div>"
                    + "</div>";
        ...
        buffer=buffer+name_row;
         ...
         String member_row="<div class=\"control-group\">"
                    ...
                    + "<input type=\"text\"  id=\"member_since\" autocomplete=\"off\" value='"+m.getMemberSince()+"'>"
                    + "</div>"
                    + "</div>"
                    + "</div>";
        ...
        String role_row="<div class=\"control-group\">"
                    ...
                    + "<input type=\"text\"  id=\"rolement\" autocomplete=\"off\" value='"+m.getRolement()+"'>"
                    + "</div>"
                    + "</div>"
                    + "</div>";
        ...
        String actionrow="<div class=\"form-actions\">"
                + "<input class=\"btn btn-primary\" value=\"تعديل\" type=\"button\" id=\"editmember\">"
